...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Kensington Alterations and Dressmaking">
    <meta name="author" content="Kaylem Thomas-Booth">
    <meta name="docsearch:language" content="en">
    <title>KAD - Contact Us</title>
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark"> <a class="navbar-brand"
      ...
      <div class="collapse navbar-collapse justify-content-md-end" id="navbar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item"> <a class="nav-link" href="#dressmaking">Dressmaking</a>
          </li>
      ...
      <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
        <div class="col-md-6">
          ...
          <form class="needs-validation">
            <div class="mb-3"> <label for="name">Name</label> <input class="form-control"

                id="name" placeholder="" value="" required="" type="text">
            ...
            <div class="mb-3"> <label for="message">Message</label> <textarea

class="form-control" id="message" placeholder="" required="" type="text"></textarea>
